...
void capture_ft_print_params_output(int (*func)(int, char**), int argc, char **argv, char* buffer, size_t size) {
	int pipefd[2];
	ssize_t count;
...
MU_TEST(test_ft_print_params_empty_params)
{
	...
	capture_ft_print_params_output(program_main, argc, argv, actual_result, sizeof(actual_result));
