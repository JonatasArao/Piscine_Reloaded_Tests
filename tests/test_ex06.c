...
void capture_ft_print_alphabet_output(void (*func)(void), char* buffer, size_t size) {
	int pipefd[2];
	ssize_t count;
...
MU_TEST(test_print_alphabet_response)
{
	...
	capture_ft_print_alphabet_output(ft_print_alphabet, actual_result, sizeof(actual_result));
